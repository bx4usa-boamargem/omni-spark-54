  ...
  public: {
    Tables: {
      ...
      aios_agent_memory: {
        ...
        Relationships: [
          {
            foreignKeyName: "aios_agent_memory_blog_id_fkey"
            columns: ["blog_id"]
            isOneToOne: false
            referencedRelation: "blogs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "aios_agent_memory_source_run_id_fkey"
            columns: ["source_run_id"]
            isOneToOne: false
            referencedRelation: "aios_task_runs"
            referencedColumns: ["id"]
          },
        ]
      }
      aios_agents: {
        ...
        Relationships: [
          {
            foreignKeyName: "aios_agents_squad_id_fkey"
            columns: ["squad_id"]
            isOneToOne: false
            referencedRelation: "aios_squads"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      aios_step_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "aios_step_logs_run_id_fkey"
            columns: ["run_id"]
            isOneToOne: false
            referencedRelation: "aios_task_runs"
            referencedColumns: ["id"]
      ...
      aios_task_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "aios_task_runs_blog_id_fkey"
            columns: ["blog_id"]
            isOneToOne: false
            referencedRelation: "blogs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "aios_task_runs_squad_id_fkey"
            columns: ["squad_id"]
            isOneToOne: false
            referencedRelation: "aios_squads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "aios_task_runs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "blogs"
            referencedColumns: ["id"]
