...
export function ServiceCardGrid({ services, primaryColor, isEditing = false, onEdit }: ServiceCardGridProps) {
  return (
            ...
            {services.map((service: any, index: number) => (
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <InlineEditableText
                    value={service.desc}
                    onChange={(value) => onEdit?.(index, 'desc', value)}
                    as="p"
                    className="text-slate-600 mb-8 leading-relaxed font-medium flex-1"
