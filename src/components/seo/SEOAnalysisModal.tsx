...
export function SEOAnalysisModal({
  ...
  const handleFix = async (type: "title" | "meta" | "content" | "density") => {
    ...
    // Keywords will be auto-generated by backend if missing - show info toast
    if (!currentArticle.keywords || currentArticle.keywords.length === 0) {
      toast.info("Palavras-chave serão geradas automaticamente");
    }
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke("improve-seo-item", {
        body: {
          type,
          currentValue,
          keywords: currentArticle.keywords || [], // Allow empty - backend will generate
          context: currentArticle.content || "",
          articleTitle: currentArticle.title,
          user_id: userId,
          blog_id: blogId,
          article_id: currentArticle.id, // Allows backend to persist generated keywords
        },
      });
      ...
      // Update local state with REAL data from DB (including auto-generated keywords)
      setCurrentArticle({
        ...currentArticle,
        title: freshArticle.title,
        meta_description: freshArticle.meta_description,
        content: freshArticle.content,
        keywords: freshArticle.keywords, // Include auto-generated keywords
        featured_image_url: freshArticle.featured_image_url,
      });
  ...
  const handleFixAll = async () => {
    ...
    // Keywords will be auto-generated by backend if missing - no blocking validation
