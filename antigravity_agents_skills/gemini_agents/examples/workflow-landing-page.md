...
**Step 1a — Activate the `content-creator` agent**
...
**Step 1b — Activate the `ui-designer` agent (in parallel)**

```
Activate the `ui-designer` agent.
...
**Step 2 — Activate the `frontend-developer` agent**
...
**Step 3 — Activate the `growth-hacker` agent**
