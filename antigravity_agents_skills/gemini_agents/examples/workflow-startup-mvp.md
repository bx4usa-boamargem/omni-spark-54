...
**Step 1 — Activate the `sprint-prioritizer` agent**

```
Activate the `sprint-prioritizer` agent.
...
**Step 2 — Activate the `ux-researcher` agent (in parallel)**

```
Activate the `ux-researcher` agent.
...
**Step 4 — Activate the `frontend-developer` agent + Rapid Prototyper**
...
```
Activate the `reality-checker` agent.
