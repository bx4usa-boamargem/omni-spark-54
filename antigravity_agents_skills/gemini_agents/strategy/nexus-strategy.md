...
"Activate the `agents-orchestrator` agent in NEXUS-Full mode for [PROJECT NAME].
...
"Activate the `agents-orchestrator` agent in NEXUS-Sprint mode for [FEATURE/MVP NAME].
