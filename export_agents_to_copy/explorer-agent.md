...
6.  **Knowledge Synthesis**: Acts as the primary information source for `biojus` and `project-planner`.
...
- When an "biojus" needs a detailed map of the system before distributing tasks.
